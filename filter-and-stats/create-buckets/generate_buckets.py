...
# Load CSV file
file_path = r"updated_buckets\filtered_data.csv"  # Update with your actual file path
...
# bucket_ranges = [(10, 15), (16, 25), (26, 35), (36, float('inf'))]  # 56+ includes all users above 55
...
for start, end in bucket_ranges:
    ...
    if not bucket_df.empty:
        bucket_df.to_csv(rf"updated_buckets\user_bucket_{bucket_label}.csv", index=False)
